...
static int ade7978_read_reg8(const struct device *dev, uint16_t addr, uint8_t *value)
{
...
static int ade7978_read_reg16(const struct device *dev, uint16_t addr, uint16_t *value)
{
	const struct ade7978_config *cfg = dev->config;
...
static int ade7978_read_reg32(const struct device *dev, uint16_t addr, uint32_t *value)
{
	const struct ade7978_config *cfg = dev->config;
...
static int ade7978_write_reg8(const struct device *dev, uint16_t addr, uint8_t value)
{
	const struct ade7978_config *cfg = dev->config;
...
static int ade7978_write_reg16(const struct device *dev, uint16_t addr, uint16_t value)
{
	const struct ade7978_config *cfg = dev->config;
...
static int ade7978_write_reg32(const struct device *dev, uint16_t addr, uint32_t value)
{
	const struct ade7978_config *cfg = dev->config;
...
static void ade7978_to_sensor_value(double value_in, struct sensor_value *value_out)
{
	value_out->val1 = (int32_t)value_in;
	value_out->val2 = (int32_t)((value_in - value_out->val1) * 1000000);
}
...
static int ade7978_attr_set(const struct device *dev, enum sensor_channel chan,
			    enum sensor_attribute attr, const struct sensor_value *val)
{
	/* Configuration not supported for now */
	return -ENOTSUP;
}

static const struct sensor_driver_api ade7978_api = {
	.attr_set = ade7978_attr_set,
